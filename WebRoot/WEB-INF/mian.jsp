		...
		<div class="layui-body">
			...
			<div id="mainContent">
				<section id="iframebox">
					<div id="iframesbox">
						<iframe  width="1100px" height="800px" onload="Javascript:SetCwinHeight()" height="1"  frameborder=0 marginheight=0 marginwidth=0
						src="${pageContext.request.contextPath}/block/mainpng.jsp" scrolling=no></iframe>
					</div>
	...
	$(".layui-side-scroll dl dd").on(
			...
			console.log(1)
				...
				if (ar == 101){
					...
					$('#iframebox').show();
					$('#iframesbox').html(
							'<iframe width="1100px" height="700px" frameborder=0 marginheight=0 marginwidth=0 src="'
				...
				if (ar == 601) {
					...
					$('#iframesbox').html(
							...
							'<iframe width="100%" id="iframeid" onload="Javascript:SetCwinHeight()" height="1"  frameborder=0 marginheight=0 marginwidth=0 src="'
